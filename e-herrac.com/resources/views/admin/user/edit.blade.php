                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('first_name', $user->first_name) }}" type="text"
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('last_name', $user->last_name) }}" type="text"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="is_active" id="is_active"
                                                ...
                                                <option value="1" @if (old('is_active', (string)$user->is_active) === '1') selected @endif>Active</option>
                                                <option value="0" @if (old('is_active', (string)$user->is_active) === '0') selected @endif
                                                    >Passive</option>
                                            </select>
                                            @error('is_active')
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="role" id="role"
                                                ...
                                                @foreach ($roles as $role)
                                                    <option value="{{ $role->id }}" @if (old('role', $user->roles->first()->id) === $role->id) selected
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <input data-fileuploader-files="{{$user->getPreloadedMedia('photo')}}" data-fileuploader="single" type="file" name="photo">
                                            </div>
                                            @error('photo')
