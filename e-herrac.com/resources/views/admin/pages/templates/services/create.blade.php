                                    ...
                                    <div class="tab-pane fade show @if(config('app.locale') === $language) active @endif" id="tab_content_{{$language}}" role="tabpanel" aria-labelledby="tab_{{$language}}">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('name.' . $language) is-invalid @enderror"
                                                id="name_{{$language}}" value="{{ old('name.'.$language) }}" name="name[{{$language}}]"/>
                                            @error('name.'.$language)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea data-editor="ckeditor" class="form-control @error('description.' . $language) is-invalid @enderror"
                                                id="description_{{$language}}" name="description[{{$language}}]">{{ old('description.' . $language) }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('content.' . $language) is-invalid @enderror"
                                                id="content_{{$language}}" name="content[{{$language}}]">{{ old('content.' . $language) }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('title_for_home.' . $language) is-invalid @enderror"
                                                id="title_for_home_{{$language}}" value="{{ old('title_for_home.'.$language) }}" name="meta[title_for_home][{{$language}}]"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('description_for_home.' . $language) is-invalid @enderror"
                                                id="description_for_home_{{$language}}" name="meta[description_for_home][{{$language}}]">{{ old('description_for_home.' . $language) }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="template" id="template" class="form-control @error('template') is-invalid @enderror">
                                                @foreach(\App\Models\Page::$templates as $key => $name)
                                                    <option value="{{$key}}" @if ($key === 'services') selected @endif>{{$name}}</option>
                                                @endforeach
                                            </select>
                                            @error('template')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <input data-fileuploader="single" type="file" name="cover_image">
                                            </div>
                                            @error('cover_image')
