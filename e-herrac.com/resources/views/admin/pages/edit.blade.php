                        ...
                        <div class="card card-primary card-outline card-outline-tabs">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('descriptio') is-invalid @enderror" id="description" name="description">{{ old('description', $page->description) }}</textarea>
                                    @error('description')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="parent_id" id="parent_id" class="form-control @error('parent_id') is-invalid @enderror">
                                                ...
                                                @foreach($parents as $parent)
                                                    <option value="{{ $parent->id }}" @if (old('parent_id', (string)$page->parent_id) === (string) $parent->id) selected @endif>{{ $parent->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('parent_id')
