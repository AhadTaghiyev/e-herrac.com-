                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('name') is-invalid @enderror"
                                                id="name" value="{{ old('name', $role->name) }}" name="name"/>
                                            @error('name')
                                            <span id="name-error"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    @foreach ($chunk as $permission)
                                                        ...
                                                        <input value="{{$permission->getOriginal('name')}}" id="permission_{{$permission->id}}" name="permissions[]" class="form-check-input" type="checkbox" @if($role->hasPermissionTo($permission->getOriginal('name'))) checked @endif>
