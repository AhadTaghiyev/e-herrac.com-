...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.auctions.update', $auction->id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-9">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('date') is-invalid @enderror" id="date" value="{{ old('date', $auction->date->format('Y-m-d')) }}" data-toggle="datetimepicker" data-target="#date" name="date"/>
                                            @error('date')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('time') is-invalid @enderror" id="time" value="{{ old('time', $auction->time) }}" data-toggle="datetimepicker" data-target="#time" name="time"/>
                                            @error('time')
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="is_active" id="is_active" class="form-control @error('is_active') is-invalid @enderror">
                                                <option value="1" @if (old('is_active', (string)$auction->is_active) === '1') selected @endif>Active</option>
                                                <option value="0" @if (old('is_active', (string)$auction->is_active) === '0') selected @endif>Passive</option>
                                            </select>
                                            @error('is_active')
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="is_repeat" id="is_repeat" class="form-control @error('is_repeat') is-invalid @enderror">
                                                <option value="1" @if (old('is_repeat', (string)$auction->is_repeat) === '1') selected @endif>Yes</option>
                                                <option value="0" @if (old('is_repeat', (string)$auction->is_repeat) === '0') selected @endif>No</option>
                                            </select>
                                            @error('is_repeat')
