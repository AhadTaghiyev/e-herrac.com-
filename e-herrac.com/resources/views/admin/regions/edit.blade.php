...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.regions.update', $region->id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="card card-primary card-outline card-outline-tabs">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror" id="name" value="{{ old('name', $region->name) }}" name="name"/>
                                    @error('name')
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="is_active" id="is_active"
                                                ...
                                                <option value="1" @if (old('is_active', (string)$region->is_active) === '1') selected @endif>Active</option>
                                                <option value="0" @if (old('is_active', (string)$region->is_active) === '0') selected @endif>Passive</option>
                                            </select>
                                            @error('is_active')
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="parent_id" id="parent_id" class="form-control @error('type') is-invalid @enderror">
                                                <option value="" @if (old('parent_id', optional($region->parent)->id) === '') selected @endif>Select parent</option>
                                                {!! $traverse($parents, '', old('parent_id', optional($region->parent)->id)) !!}
                                            </select>
                                            @error('type')
