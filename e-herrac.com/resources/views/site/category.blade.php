      ...
      <div class="w-full md:w-2/3 flex-col md:flex-row flex md:pl-6">
        <div class="w-full">
          <h2 class="text-xl text-gray-700 font-bold border-b pb-4 mb-4 flex items-center">
            Elanlar
            <select name="sort" class="ml-auto bg-transparent p-2 border rounded border-gray-300 text-sm focus:outline-none">
              <option value="date">tarixə görə</option>
              <option value="price_low">əvvəlcə ucuz</option>
              <option value="price_high">əvvəlcə bahalı</option>
            </select>
          </h2>
          <div>
            <p class="border-blue-500 bg-blue-100 border rounded p-2">
              {{$advertisements->total()}} elan taıldı
            </p>
          </div>
